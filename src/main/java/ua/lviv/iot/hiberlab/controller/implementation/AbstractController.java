...
public abstract class AbstractController<T> implements Controller<T> {
  ...
  protected <R> void enterValueForColumn(T entity, BiConsumer<T, R> setter, String columnName,
  ...
  protected <R> void enterEntityValueForColumn(T entity, BiConsumer<T, R> setter, String columnName,
