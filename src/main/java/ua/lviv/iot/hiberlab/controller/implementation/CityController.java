...
public class CityController extends AbstractController<CityEntity> {
  ...
  private static final List<String> COLUMNS_NAMES =
      List.of("id", "name", "postal_code", "country", "region");
  ...
  public CityEntity create(CityEntity entity) {
    ...
    super.enterValueForColumn(entity, CityEntity::setPostalCode, "postal_code", String.class, true,
        6);
    super.enterEntityValueForColumn(entity, CityEntity::setCountryByCountryId, "country_id",
        new CountryService(), false);
    super.enterEntityValueForColumn(entity, CityEntity::setRegionByRegionId, "region_id",
        new RegionService(), true);
  ...
  public CityEntity update(Integer id, CityEntity entity) {
    ...
    switch (column) {
      case "name":
        ...
        break;
      case "postal_code":
        super.enterValueForColumn(entity, CityEntity::setPostalCode, "postal_code", String.class,
            true, 6);
        break;
      case "country":
        super.enterEntityValueForColumn(entity, CityEntity::setCountryByCountryId, "country_id",
  ...
  protected List<String> entityToList(CityEntity entity) {
    ...
    String regionName =
        entity.getRegionByRegionId() == null ? "-" : entity.getRegionByRegionId().getName();
