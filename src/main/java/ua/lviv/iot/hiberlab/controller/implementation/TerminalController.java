...
public class TerminalController extends AbstractController<TerminalEntity> {
  ...
  private static final List<String> COLUMNS_NAMES =
      List.of("id", "gps_coordinates", "commissioning_date", "manufacturer", "address_id");
  ...
  public TerminalEntity create(TerminalEntity entity) {
    super.enterValueForColumn(entity, TerminalEntity::setGpsCoordinates, "gps_coordinates",
        String.class, true, 24);
    super.enterValueForColumn(entity, TerminalEntity::setCommissioningDate, "commissioning_date",
        Date.class, true, -1);
    super.enterEntityValueForColumn(entity, TerminalEntity::setManufacturerByManufacturerId,
        "manufacturer_id", new ManufacturerService(), false);
    super.enterEntityValueForColumn(entity, TerminalEntity::setAddressByAddressId, "address_id",
        new AddressService(), false);
  ...
  public TerminalEntity update(Integer id, TerminalEntity entity) {
    ...
    switch (column) {
      ...
      case "commissioning_date":
        super
            .enterValueForColumn(entity, TerminalEntity::setCommissioningDate, "commissioning_date",
                Date.class, true, -1);
        break;
      case "manufacturer":
        super.enterEntityValueForColumn(entity, TerminalEntity::setManufacturerByManufacturerId,
  ...
  protected List<String> entityToList(TerminalEntity entity) {
    ...
    String commissioningDate = entity.getCommissioningDate().toString();
    ...
    return new LinkedList<>(
        List.of(id, gpsCoordinates, commissioningDate, manufacturerName, addressId));
  }
}
