...
public class ServiceController extends AbstractController<ServiceEntity> {
  ...
  private static final List<String> COLUMNS_NAMES =
      List.of("id", "date", "terminal_id", "workman", "service_type", "duration_in_hours",
          "total_price_uah");
  ...
  public ServiceEntity create(ServiceEntity entity) {
    ...
    super.enterValueForColumn(entity, ServiceEntity::setDurationInHours, "duration_in_hours",
        BigDecimal.class, false, -1);
    super.enterEntityValueForColumn(entity, ServiceEntity::setTerminalByTerminalId, "terminal_id",
        new TerminalService(), false);
    super.enterEntityValueForColumn(entity, ServiceEntity::setWorkmanByWorkmanId, "workman_id",
        new WorkmanService(), false);
    super.enterEntityValueForColumn(entity, ServiceEntity::setServiceTypeByServiceTypeId,
        "service_type_id", new ServiceTypeService(), true);
  ...
  public ServiceEntity update(Integer id, ServiceEntity entity) {
    ...
    switch (column) {
      ...
      case "duration_in_hours":
        ...
        break;
      case "terminal_id":
        super.enterEntityValueForColumn(entity, ServiceEntity::setTerminalByTerminalId,
            "terminal_id", new TerminalService(), false);
        break;
      case "workman":
        super.enterEntityValueForColumn(entity, ServiceEntity::setWorkmanByWorkmanId, "workman_id",
            new WorkmanService(), false);
  ...
  protected List<String> entityToList(ServiceEntity entity) {
    ...
    String workmanFullName = entity.getWorkmanByWorkmanId().getName() + " "
        + entity.getWorkmanByWorkmanId().getSurname();
    String serviceTypeName = entity.getServiceTypeByServiceTypeId() == null ? "-" :
        entity.getServiceTypeByServiceTypeId().getType();
    String durationInHours = entity.getDurationInHours().toString();
    String totalPriceUah =
        entity.getTotalPriceUah() == null ? "..." : entity.getTotalPriceUah().toString();
    return new LinkedList<>(
        List.of(id, date, terminalId, workmanFullName, serviceTypeName, durationInHours,
            totalPriceUah));
  }
}
