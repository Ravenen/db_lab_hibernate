...
import ua.lviv.iot.hiberlab.controller.implementation.*;
...
public class View {
  ...
  private Map<String, Printable> generateCountryMenuMethods() {
    ...
    ViewOperations<CountryEntity> countryOperation = new ViewOperations<>(countryController,
            CountryEntity.class);
  ...
  private Map<String, Printable> generateRegionMenuMethods() {
    ...
    ViewOperations<RegionEntity> regionOperation = new ViewOperations<>(regionController,
            RegionEntity.class);
  ...
  private Map<String, Printable> generateCityMenuMethods() {
    ...
    ViewOperations<CityEntity> cityOperation = new ViewOperations<>(cityController,
            CityEntity.class);
  ...
  private Map<String, Printable> generateAddressMenuMethods() {
    ...
    ViewOperations<AddressEntity> addressOperation = new ViewOperations<>(addressController,
            AddressEntity.class);
  ...
  private Map<String, Printable> generateManufacturerMenuMethods() {
    ...
    ViewOperations<ManufacturerEntity> manufacturerOperation = new ViewOperations<>(manufacturerController, ManufacturerEntity.class);
  ...
  private Map<String, Printable> generateTerminalTypeMenuMethods() {
    ...
    ViewOperations<TerminalTypeEntity> terminalTypeOperation = new ViewOperations<>(terminalTypeController, TerminalTypeEntity.class);
  ...
  private Map<String, Printable> generatePositionMenuMethods() {
    ...
    ViewOperations<PostEntity> positionOperation = new ViewOperations<>(positionController,
            PostEntity.class);
  ...
  private Map<String, Printable> generateWorkmanMenuMethods() {
    ...
    ViewOperations<WorkmanEntity> workmanOperation = new ViewOperations<>(workmanController,
            WorkmanEntity.class);
  ...
  private Map<String, Printable> generateServiceMenuMethods() {
    ...
    ViewOperations<ServiceEntity> serviceOperation = new ViewOperations<>(serviceController,
            ServiceEntity.class);
