...
public class ServiceEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (!durationInHours.equals(that.durationInHours)) return false;
        if (!totalPriceUah.equals(that.totalPriceUah)) return false;
        if (!terminalByTerminalId.equals(that.terminalByTerminalId)) return false;
        if (!workmanByWorkmanId.equals(that.workmanByWorkmanId)) return false;
